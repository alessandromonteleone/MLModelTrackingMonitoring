# Tracking of Machine Learning Experiments with MLflow
...
First of all the **training set must be loaded** on the *MySQL DB dataset*, in order to train *ML model* and perform the
